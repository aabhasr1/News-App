...
class Headlines : BaseApiResponse() {
    ...
    fun toHeadLinesList(): ArrayList<`in`.learning.aabhasjindal.newsapp.data.model.database.Headline> {
        val headLineDataList = ArrayList<`in`.learning.aabhasjindal.newsapp.data.model.database.Headline>()
        articles!!.forEach {
